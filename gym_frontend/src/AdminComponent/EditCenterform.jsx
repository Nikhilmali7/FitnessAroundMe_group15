...
class EditCenterComponent extends Component {
    ...
    componentDidMount(){
        ...
        AdminServices.centerById(this.state.location.state.id).then((response)=>{
            ...
            this.setState({locality: response.data.locality})
...
console.log(center)
        ...
        AdminServices.updateCenter(center).then(res => {
                ...
                <div className="contianer">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h1 className="text-center"> Edit Center Registration Form</h1>
                            <div className="card-body">

                                <form>
                                    <div className="form-group">
                                        <label> Center ID: </label>
                                        <input placeholder="Center ID" type="text" name="id" className="form-control"
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <select className="form-control" value={this.state.type} onChange={this.changeTypeHandler}>
                                            <option  value='' disabled="disabled" defaultValue={this.state.type} >select a type</option>
                                    ...
                                    {/* <div className="form-group">
                                        <label> Center's Type: </label>
                                        <input placeholder="Locality" type="text" name="type" className="form-control"
